...
<!-- Page Heading -->
<div id="user_profile" class="col-lg-12 col-md-12 col-sm-12 shadow bg_section">

<h2 class="h_section">Your Profile</h2>
      ...
      <div class="card shadow col-lg-7 p-4">
        ...
        <div class="pb-4">
          ...
          <div class="d-inline-block">
            ...
            <p id="data-name" class="h5 mb-0 font-weight-bold text-gray-800 text-capitalize user-data"><?php echo $user_fname.' '.$user_lname?></p>
